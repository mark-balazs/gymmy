...
Dropping a table takes two deploys: stop using it, then drop it after counting its rows in production. ref_sets was dropped this way; production had 0 rows.
