...
appears:
  ...
  copy: ["plan.shared", "plan.by.one", "plan.by.other", "plan.days.one", "plan.days.other", "plan.apply", "plan.applyBody", "plan.applyFailed", "plan.missing", "plan.orYourOwn", "coach.deleteBody"]
