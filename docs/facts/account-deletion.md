...
appears:
  ...
  copy: ["set.deleteTitle", "set.deleteBody", "set.deleteGo", "set.deleteQ", "set.deleteWhat", "set.deleteSets.one", "set.deleteSets.other", "set.deleteWeeks.one", "set.deleteWeeks.other", "set.deleteForever", "set.deleteConfirm"]
