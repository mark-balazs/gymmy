...
Every save reports its own failure. The header's sync dot (green saved, amber offline, red needs attention) keeps 'not saved on this device' apart from 'not synced yet'.
