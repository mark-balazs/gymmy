...
appears:
  ...
  tests: ["e2e/tests/navigation.spec.ts", "e2e/tests/plans.spec.ts", "apps/web/src/components/tabs.test.ts"]
  confluence: ["934608916", "934445118"]
---

Five tabs in this order, swipeable: Home, Train, Week, Progress, Settings. Switching tabs never adds to Back: Back leaves a screen opened from a tab (Build your own, Coaching), then the app. Trainers reach a Coaching screen from Settings; it is not a sixth tab.
