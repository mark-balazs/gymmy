...
appears:
  ...
  copy: ["set.you", "set.aboutYou", "set.name", "set.namePlaceholder", "set.birthYear", "set.birthYearPlaceholder", "set.birthYearWhy", "set.yearBad", "set.picAdd", "set.picChange", "set.picRemove", "set.picRemoved", "set.picUndo", "set.picBad", "set.picTooBig", "set.sex", "set.sexWhy", "sex.unspecified", "sex.female", "sex.male", "set.height"]
