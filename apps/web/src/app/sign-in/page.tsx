    ...
    <main className="grid min-h-dvh place-items-center p-6">
      <div className="flex max-w-[360px] flex-col items-center gap-4 text-center">
        ...
        >
          ...
          >
            {/* Google's mark has to sit on white — it is four fixed colours and
                loses its meaning on any other ground, which is why their own
                guidelines put it in a tile rather than inline on a button. */}
            <span className="grid h-6 w-6 shrink-0 place-items-center rounded-[7px] bg-white">
