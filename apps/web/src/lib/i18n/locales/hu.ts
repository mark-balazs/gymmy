...
export const hu: Record<Key, string> = {
  ...
  'week.complete.one': '{n}/{n} mozgásforma megvan, {s} alatt. Ez egy teljes hét.',
  'week.complete.other': '{n}/{n} mozgásforma megvan, {s} alatt. Ez egy teljes hét.',
  ...
  'split.minDays.one': 'Legalább heti {n} nap kell hozzá',
  'split.minDays.other': 'Legalább heti {n} nap kell hozzá',
