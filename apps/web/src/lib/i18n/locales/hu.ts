...
export const hu: Record<Key, string> = {
  ...
  'prog.needsLook': 'Érdemes ránézni',
  'prog.allClear': 'Most nincs mire ránézni. Minden gyakorlatod halad.',
  'prog.kregressed': 'Vissza',
  'prog.kstalled': 'Megállt',
  'prog.kdormant': 'Kimaradt',
  'prog.vRegressed': '{pct}%-kal a csúcsod alatt, amit ekkor értél el: {date}.',
  'prog.vStalled': 'Nem ment feljebb {date} óta, {s} alatt sem.',
