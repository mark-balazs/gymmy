...
export const LINKS: Link[] = [
  ...
  {
    // Not "programmes" or "programs": those words belong to the planned
    // Programmes feature, where a trainer runs somebody's training. A program
    // entry is one cell of the generated week — this exercise, in this slot, on
    // this day.
