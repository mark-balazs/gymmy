 ...
 * progress charts have no line, neither strength number has anything to divide,
 * and a goal has no history to be judged against. So the demo account arrives
 * having already trained.
 *
